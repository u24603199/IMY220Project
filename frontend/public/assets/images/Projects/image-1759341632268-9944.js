...
function loadFunction(){
    ...
    req1.onreadystatechange = function()
    {
        if(req1.readyState == 4 && req1.status == 200){
            ...
            var table = document.getElementById("wish_Table");
            table.deleteRow(1);
            var substitute = 'cost';
            for(var i = 0; i < app.data.length; i++){
                ...
                "<p id=" + substitute + "> Price: " + conversion(app.data[i].currency, app.data[i].final_price) + " " + Symbol + "</p><br>"// Prices please implement the price API later 
                + "</tr></td>";
            }
        }
    }
